...
select ss.ss_sold_date_sk,ss.ss_store_sk,ss.ss_customer_sk,ss.ss_quantity,ss.ss_sales_price
from bronze.store_sales_raw ss
join snowflake_sample_data.tpcds_sf100tcl.date_dim d 
on ss.ss_sold_date_sk=d.d_date_sk
where d.d_year between 1998 and 1999 and ss.ss_sales_price is not null and ss.ss_quantity>0;
